...
def build_business_result(manifest: dict[str, Any], *, mode: str = "opencode-skill") -> dict[str, Any]:
    ...
    bidder_instruction_rows = _extract_bidder_instruction_rows(documents, texts_by_id)
    field_groups = {
