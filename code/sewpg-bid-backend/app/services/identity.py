...
CUSTOMER_REGISTRY = [
    ...
    {
        # 规范名取素材库客户目录名「国电投」，保证按客户取素材时直接命中目录；
        # 别名覆盖「国家电投」——建项目弹窗此前的硬编码清单用的是这个写法，
        # 历史项目里可能已经存了它（2026-08-07 素材库实有目录：华能集团、国电投）。
        "customerId": "CUST-SPIC",
        "customerCanonicalName": "国电投",
        "customerAliases": ["国电投", "国家电投", "国家电力投资", "国家电力投资集团", "中电投"],
    },
]
