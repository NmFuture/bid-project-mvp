...
from app.models.materials import TemplateAsset
...
def test_check_opencode_attaches_warning_without_failing() -> None:
    ...
    with patch.object(system_settings_service, "_check_http", new=AsyncMock(return_value=dict(base_item))), patch.object(
