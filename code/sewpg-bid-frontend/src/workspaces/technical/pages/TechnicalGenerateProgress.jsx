...
export default function TechnicalGenerateProgress({ showToast }) {
  const { id } = useParams()
  ...
  const handleGoEditor = async () => {
    ...
    setAdvancing(true)
    try {
      await technicalStagesAPI.update(id, 4, { status: 'completed' })
      showToast?.('已进入共创导出')
  ...
  const renderProgressDialog = () => {
    ...
    const closeDialog = () => {
      if (dialogCanClose) setProgressDialogOpen(false)
    }
    ...
    return (
      <Dialog open={progressDialogOpen} onClose={closeDialog} size="lg">
  ...
  return (
    <div className="stage-page technical-ui-shell flex flex-col gap-6 animate-fade-in w-full max-w-none">
      ...
      <DataCard className="!p-0 overflow-hidden technical-panel min-h-[360px]">
        ...
        {status === 'idle' ? (
          ...
          <div className="bg-surface-container-low px-4 py-4 flex flex-col gap-4">
            <div className="grid grid-cols-1 xl:grid-cols-12 gap-6">
              <div className="technical-panel xl:col-span-7 rounded-md border border-surface-container-high bg-surface-container-lowest p-4">
              ...
              <div className="technical-panel xl:col-span-5 rounded-md border border-surface-container-high bg-surface-container-lowest p-4">
            ...
            <div className="technical-panel rounded-md border border-surface-container-high bg-surface-container-lowest p-4">
              <div className="flex items-center justify-between gap-3 mb-4">
            ...
            {isCompleted ? (
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="technical-panel rounded-md border border-surface-container-high bg-white p-4">
