...
import { technicalCoverageAPI, technicalStagesAPI } from '../../../api'
...
export default function TechnicalCoverageHeatmap({ showToast }) {
  const { id } = useParams()
  ...
  const fetchCoverage = useCallback(async () => {
    setLoading(true)
    try {
      const payload = await technicalCoverageAPI.get(id)
      setData(payload)
      setError('')
    } catch (e) {
