...
- `S3` 当前已认可的收口点是第一个缺口识别 Skill：读取 S2 已确认目录、技术标 Wiki、项目/客户/通用素材边界和投标机型，形成完整缺口处理计划；空副表/Word 填写与完整性复查仍待重新规划验收
...
- [技术标与商务标需求整理](./doc/15-技术标与商务标需求整理.md)
  - 技术标、商务标需求来源和讨论依据
- [目标一与目标二最终目标](./doc/16-目标一与目标二最终目标.md)
...
- 涉及附表填写、待填写 Word、85% 人工基准验收时，同时先读 `doc/16`
